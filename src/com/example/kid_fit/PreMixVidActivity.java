...
import com.example.kid_fit.adapter.PreMixVidAdapter;
...
public class PreMixVidActivity extends Activity {

	public static final String PREFS_NAME = "LoginPrefs";
	public EditText et_searchpremixvid;
	...
	public ListView lv_listpremixvid;
	...
	public PreMixVidAdapter ListViewAdapter;
	public ArrayList<PreMixMus> json_vid_list = new ArrayList<PreMixMus>();
	...
	public Intent premixvidintent2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.premixvidlist_ui);
		...
		et_searchpremixvid = (EditText) findViewById(R.id.etsearchpremixvid);
		...
		et_searchpremixvid.setOnTouchListener(new OnTouchListener() {
			@Override
	...
	private class getDataList extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			pDialog.setMessage("Searching Video...");
		...
		protected String doInBackground(String... args) {
			...
			params.add(new BasicNameValuePair("music_type", "2"));
	...
	public void populateUI() {
		...
		lv_listpremixvid = (ListView) findViewById(R.id.lvlistpremixvid);
		lv_listpremixvid.setFadingEdgeLength(0);

		ListViewAdapter = new PreMixVidAdapter(this, json_vid_list);
		lv_listpremixvid.setAdapter(ListViewAdapter);

		// Capture Text in EditText
		et_searchpremixvid.addTextChangedListener(new TextWatcher() {

			@Override
			public void afterTextChanged(Editable arg0) {
				// TODO Auto-generated method stub
				String text = et_searchpremixvid.getText().toString().trim()
		...
		lv_listpremixvid.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v,
				...
				if (ll_menulayout.getVisibility() == View.VISIBLE) {
					...
					PreMixMus mPreMixMus = new PreMixMus();
					mPreMixMus = json_vid_list.get(position);
					...
					filename = mPreMixMus.getPreMixMustitle()
							...
							+ mPreMixMus.getPreMixMusartistname() + ".mp4";
					;
					filepath = mPreMixMus.getPreMixMuspath();
					if (mPreMixMus.getPreMixPathMatch().equals("Match")) {
						Intent premixvidintent = new Intent(
								PreMixVidActivity.this,
								PreMixVidNowPlayActivity.class);
						premixvidintent.putExtra("FAV_STATUS", favstatus);
						premixvidintent.putExtra("TRACK_PATH",
								mPreMixMus.getPreMixMuspath());
						premixvidintent.putExtra("TRACK_ID",
								mPreMixMus.getPreMixMusid());
						premixvidintent.putExtra("FILE_NAME",
								KidFitFile.getPath() + "/" + filename);
						finish();
						startActivity(premixvidintent);
						overridePendingTransition(R.anim.slide_in_activity,
								R.anim.slide_out_activity);
					} else if (mPreMixMus.getPreMixPathMatch().equals(
							"Not Match")) {
						premixvidintent2 = new Intent(PreMixVidActivity.this,
								PreMixVidNowPlayActivity.class);
						premixvidintent2.putExtra("FAV_STATUS", favstatus);
						premixvidintent2.putExtra("TRACK_PATH",
								mPreMixMus.getPreMixMuspath());
						premixvidintent2.putExtra("TRACK_ID",
								mPreMixMus.getPreMixMusid());
						dialogaskdownloadli = LayoutInflater
								.from(PreMixVidActivity.this);
	...
	public void downloadFile(String filename1) {
		...
		try {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					dialog.cancel();
					premixvidintent2.putExtra("FILE_NAME", KidFitFile.getPath()
							+ "/" + filename);
					finish();
					startActivity(premixvidintent2);
					overridePendingTransition(R.anim.slide_in_activity,
							R.anim.slide_out_activity);
				}
			});
	...
	public void clickhome(View v) {
		if (ll_menulayout.getVisibility() == View.VISIBLE) {
			...
			Toast.makeText(getApplicationContext(), "Home", Toast.LENGTH_LONG)
					.show();
			finish();
			Intent homeintent = new Intent(PreMixVidActivity.this,
					HomeActivity.class);
