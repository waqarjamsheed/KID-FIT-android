...
import com.example.kid_fit.adapter.PreMixMusPlayAdapter;
...
public class PreMixMusPlayActivity extends Activity {

	public static final String PREFS_NAME = "LoginPrefs";
	public EditText et_searchpremixmusplay;
	...
	public ListView lv_listpremixmusplay;
	...
	public PreMixMusPlayAdapter ListViewAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.premixmusplay_ui);
		...
		et_searchpremixmusplay = (EditText) findViewById(R.id.etsearchpremixmusplay);
		...
		et_searchpremixmusplay.setOnTouchListener(new OnTouchListener() {
			@Override
		...
		protected void onPostExecute(String file_url) {
			...
			if (file_url.equals("1")) {
				Toast.makeText(getApplicationContext(),
						"Pre-Mixed Music Playlists", Toast.LENGTH_LONG).show();
	...
	public void populateUI() {
		...
		lv_listpremixmusplay = (ListView) findViewById(R.id.lvlistpremixmusplay);
		lv_listpremixmusplay.setFadingEdgeLength(0);

		ListViewAdapter = new PreMixMusPlayAdapter(this, json_play_list);
		lv_listpremixmusplay.setAdapter(ListViewAdapter);

		// Capture Text in EditText
		et_searchpremixmusplay.addTextChangedListener(new TextWatcher() {

			@Override
			public void afterTextChanged(Editable arg0) {
				// TODO Auto-generated method stub
				String text = et_searchpremixmusplay.getText().toString()
		...
		lv_listpremixmusplay.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v,
				...
				if (ll_menulayout.getVisibility() == View.VISIBLE) {
					...
					Toast.makeText(getApplicationContext(),
							...
							Toast.LENGTH_LONG).show();
					Intent premixmusplayintent = new Intent(
							PreMixMusPlayActivity.this, PreMixMusActivity.class);
					premixmusplayintent.putExtra("PLAY_ID",
							mPreMixMusPlay.getPreMixMusPlayid());
					startActivity(premixmusplayintent);
	...
	public void clickhome(View v) {
		if (ll_menulayout.getVisibility() == View.VISIBLE) {
			...
			Toast.makeText(getApplicationContext(), "Home", Toast.LENGTH_LONG)
					.show();
			finish();
			Intent homeintent = new Intent(PreMixMusPlayActivity.this,
					HomeActivity.class);
