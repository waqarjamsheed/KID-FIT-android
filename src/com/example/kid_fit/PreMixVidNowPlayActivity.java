...
public class PreMixVidNowPlayActivity extends Activity {

	public static final String PREFS_NAME = "LoginPrefs";
	public LinearLayout ll_menulayout, ll_windowlayout, ll_windowsublayout, ll_premixmusnowplayfav;
	...
	public VideoView vv_premixvidnowplay;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.premixvidnowplay_ui);
		...
		iv_premixmusnowplayfav = (ImageView) findViewById(R.id.ivpremixvidnowplayfav);
		ll_premixmusnowplayfav = (LinearLayout) findViewById(R.id.llpremixvidnowplayfav);
		vv_premixvidnowplay = (VideoView) findViewById(R.id.vvpremixvidnowplay);
		...
		vv_premixvidnowplay.setOnTouchListener(new OnTouchListener() {
			@Override
			public boolean onTouch(View v, MotionEvent event) {
				...
				case MotionEvent.ACTION_DOWN:
					if (ll_menulayout.getVisibility() == View.VISIBLE) {
						...
						vv_premixvidnowplay.start();
					} else {
						mediacontroller.show();
						if (videoplay) {
							vv_premixvidnowplay.pause();
							videoplay = false;
		...
		pDialog.setTitle("Now Playing Video");
		...
		try {
			...
			mediacontroller = new MediaController(
					PreMixVidNowPlayActivity.this);
			mediacontroller.setAnchorView(vv_premixvidnowplay);
			// Get the URL from String VideoURL
			Uri video = Uri.parse(filename);
			vv_premixvidnowplay.setMediaController(mediacontroller);
			vv_premixvidnowplay.setVideoURI(video);
		...
		vv_premixvidnowplay.requestFocus();
		vv_premixvidnowplay.setOnPreparedListener(new OnPreparedListener() {
		...
		protected void onPostExecute(String file_url) {
			...
			if (file_url.equals("1") && favstatustouch == 1) {
				Toast.makeText(getApplicationContext(),
						"This video has been added in favourite list",
						Toast.LENGTH_LONG).show();
			} else if (file_url.equals("3") && favstatustouch == 0) {
				Toast.makeText(getApplicationContext(),
						"This video has been deleted from favourite list",
						Toast.LENGTH_LONG).show();
				...
				Toast.makeText(getApplicationContext(),
						"This video already exists in favourite list", Toast.LENGTH_LONG).show();
	...
	public void clickhome(View v) {
		if (ll_menulayout.getVisibility() == View.VISIBLE) {
			...
			Toast.makeText(getApplicationContext(), "Home", Toast.LENGTH_LONG)
					.show();
			finish();
			Intent homeintent = new Intent(PreMixVidNowPlayActivity.this,
					HomeActivity.class);
