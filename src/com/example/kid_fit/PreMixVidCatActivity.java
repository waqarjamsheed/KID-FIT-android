...
import com.example.kid_fit.adapter.PreMixVidCatAdapter;
...
public class PreMixVidCatActivity extends Activity {

	public static final String PREFS_NAME = "LoginPrefs";
	public EditText et_searchpremixvidcat;
	...
	public ListView lv_listpremixvidcat;
	...
	public PreMixVidCatAdapter ListViewAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		et_searchpremixvidcat.setOnTouchListener(new OnTouchListener() {
			@Override
		...
		protected void onPostExecute(String file_url) {
			...
			if (file_url.equals("1")) {
				Toast.makeText(getApplicationContext(),
						"Pre-Mixed Video Categories", Toast.LENGTH_LONG).show();
	...
	public void populateUI() {
		...
		lv_listpremixvidcat = (ListView) findViewById(R.id.lvlistpremixvidcat);
		lv_listpremixvidcat.setFadingEdgeLength(0);

		ListViewAdapter = new PreMixVidCatAdapter(this, json_cat_list);
		lv_listpremixvidcat.setAdapter(ListViewAdapter);

		// Capture Text in EditText
		et_searchpremixvidcat.addTextChangedListener(new TextWatcher() {

			@Override
			public void afterTextChanged(Editable arg0) {
				// TODO Auto-generated method stub
				String text = et_searchpremixvidcat.getText().toString().trim()
		...
		lv_listpremixvidcat.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v,
				...
				if (ll_menulayout.getVisibility() == View.VISIBLE) {
					...
					Toast.makeText(getApplicationContext(),
							...
							Toast.LENGTH_LONG).show();
					Intent premixvidcatintent = new Intent(
							PreMixVidCatActivity.this,
							PreMixVidPlayActivity.class);
					premixvidcatintent.putExtra("CAT_ID",
							mPreMixMusCat.getPreMixMusCatid());
					startActivity(premixvidcatintent);
	...
	public void clickhome(View v) {
		if (ll_menulayout.getVisibility() == View.VISIBLE) {
			...
			Toast.makeText(getApplicationContext(), "Home", Toast.LENGTH_LONG)
					.show();
			finish();
			Intent homeintent = new Intent(PreMixVidCatActivity.this,
					HomeActivity.class);
