...
public class PreMixVidCatAdapter extends BaseAdapter {
	...
	public PreMixVidCatAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.inflatepremixvidcatlist_ui, parent,
					false);
			holder = new ViewHolder();
			holder.tv_vidcat = (TextView) convertView
					.findViewById(R.id.tvvidcat);
			convertView.setTag(holder);
		} else {
			holder = (ViewHolder) convertView.getTag();
		}
		holder.tv_vidcat.setText(rowItem.getPreMixMusCatname());
