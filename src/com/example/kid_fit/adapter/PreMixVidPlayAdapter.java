...
public class PreMixVidPlayAdapter extends BaseAdapter {
	...
	public PreMixVidPlayAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.inflatepremixvidplaylist_ui, parent,
					false);
			holder = new ViewHolder();
			holder.tv_vidplay = (TextView) convertView
					.findViewById(R.id.tvvidplay);
			convertView.setTag(holder);
		} else {
			holder = (ViewHolder) convertView.getTag();
		}
		holder.tv_vidplay.setText(rowItem.getPreMixMusPlayname());
