...
import com.example.kid_fit.adapter.DownloadsAdapter;
...
public class DownloadsActivity extends Activity {
	...
	public DownloadsAdapter ListViewAdapter;
	...
	private class getDataList extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			if (file_url.equals("1")) {
				Toast.makeText(getApplicationContext(), "All Downloads",
						Toast.LENGTH_LONG).show();
	...
	public void populateUI() {
		...
		ListViewAdapter = new DownloadsAdapter(this, json_all_list);
				...
				if (ll_menulayout.getVisibility() == View.VISIBLE) {
					...
					if (mAllTracks.getAllTracksPathMatch().equals("Match")) {
						...
						overridePendingTransition(R.anim.slide_in_activity,
							...
							"Not Match")) {
						alltracksintent2 = new Intent(DownloadsActivity.this,
								AllTracksNowPlayActivity.class);
						dialogaskdownloadli = LayoutInflater
								.from(DownloadsActivity.this);
	...
	public void clickhome(View v) {
		if (ll_menulayout.getVisibility() == View.VISIBLE) {
			...
			Toast.makeText(getApplicationContext(), "Home", Toast.LENGTH_LONG)
					.show();
			finish();
			Intent homeintent = new Intent(DownloadsActivity.this,
					HomeActivity.class);
