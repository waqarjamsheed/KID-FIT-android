...
public class VideoActivity extends Activity {
	...
	public LayoutInflater dialogmyvidplaylistli;
	public View dialogmyvidplaylistView;
	...
	public TextView tv_diaok, tv_dialogin;
	...
	public void clickpremixedvideos(View v) {
		if (ll_menulayout.getVisibility() == View.VISIBLE) {
			ll_menulayout.startAnimation(menuanimation1);
			ll_menulayout.setVisibility(View.GONE);
			ll_windowsublayout.startAnimation(windowanimation2);
			...
			Toast.makeText(getApplicationContext(), "Pre-Mixed Videos",
					Toast.LENGTH_LONG).show();
			Intent premixedvidintent = new Intent(VideoActivity.this,
					PreMixVidCatActivity.class);
			startActivity(premixedvidintent);
			overridePendingTransition(R.anim.slide_in_activity,
					R.anim.slide_out_activity);
		}
	}

	public void clickmyvideos(View v) {
		if (ll_menulayout.getVisibility() == View.VISIBLE) {
			ll_menulayout.startAnimation(menuanimation1);
			ll_menulayout.setVisibility(View.GONE);
			ll_windowsublayout.startAnimation(windowanimation2);
			...
			dialogmyvidplaylistli = LayoutInflater.from(VideoActivity.this);
			dialogmyvidplaylistView = dialogmyvidplaylistli.inflate(
			...
			alertDialogBuilder.setView(dialogmyvidplaylistView);
			btn_diaclose = (Button) dialogmyvidplaylistView
					.findViewById(R.id.btndiaclose);
			tv_diaok = (TextView) dialogmyvidplaylistView
					.findViewById(R.id.tvdiaok);
			tv_dialogin = (TextView) dialogmyvidplaylistView
	...
	public void clickdiaok(View v) {
		alertDialog.cancel();
		Intent myvidintent = new Intent(VideoActivity.this,
				MyVidPlayListActivity.class);
		startActivity(myvidintent);
		overridePendingTransition(R.anim.slide_in_activity,
				R.anim.slide_out_activity);
	}
	...
	public void clickdialogin(View v) {
		...
		try {
			Intent browserIntent = new Intent(
					Intent.ACTION_VIEW,
					Uri.parse("https://www.google.com.pk/?gws_rd=cr,ssl&ei=UHk7VqL1EcT5PfeftfAD"));
	...
	public void clickfavvideos(View v) {
		if (ll_menulayout.getVisibility() == View.VISIBLE) {
			ll_menulayout.startAnimation(menuanimation1);
			ll_menulayout.setVisibility(View.GONE);
			ll_windowsublayout.startAnimation(windowanimation2);
			...
			Toast.makeText(getApplicationContext(), "Favourite Videos",
					Toast.LENGTH_LONG).show();
			Intent favvidintent = new Intent(VideoActivity.this,
					FavVidActivity.class);
	...
	public void clickhome(View v) {
		if (ll_menulayout.getVisibility() == View.VISIBLE) {
			...
			Toast.makeText(getApplicationContext(), "Home", Toast.LENGTH_LONG)
					.show();
			finish();
			Intent homeintent = new Intent(VideoActivity.this,
					HomeActivity.class);
